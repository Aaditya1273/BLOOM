...
See **[DEPLOYMENT.md](DEPLOYMENT.md)**. Quick start (local):
...
- Local: `deployments/localhost.json` (generated).
- Testnet: `deployments/robinhood-testnet.json`, written by `npm run deploy:testnet`.
